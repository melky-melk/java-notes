...
//class name which has to be the same as the filename
public class Anatomy{ //opening brackets that contain the entire program
    //static means that you can run the class without creating an object within it
    //main method (starting point)
    //String[] command line arguements are saved as an array. in python remember that sys.argv gave the command line as a list, in java it is an array i think? 
    public static void main(String[] args){
        //system.out as in the system is outputting to the screen
        System.out.println("Hello! This will output to the screen");
        //setting integerVar to 1. the int is put in front to declar the variable type and the 1 sets it as 1
        int integerVar = 1;
        //converts to primitive type double
        double d1 = 1.5;
        //every class made is a reference type???
        ...
        //s is now assigned to the input the user gives in the lines
        s = keyboard.nextLine();
        //then it prints s
